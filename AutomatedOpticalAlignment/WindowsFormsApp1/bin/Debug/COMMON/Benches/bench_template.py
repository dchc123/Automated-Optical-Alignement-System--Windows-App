from COMMON.Benches.base_bench import BaseBench
# TODO: import resources to be used from CLI.Devices, CLI.Equipment, or CLI.Interfaces
# from CLI.from CLI.Devices.GN2104X.gn2104 import GN2104
# from CLI.Equipment.PowerSupply.KeysightE36XXX.keysight_e3646a import KeysightE3646A


# TODO: Rename bench class to match desired bench name
class BenchName(BaseBench):
    def __init__(self, dummy_mode=False):
        ...
        # TODO: Instantiate desired resource here with its required arguments, like address
        # TODO: Be sure to use benches dummy_mode when instantiating
    ...
    def aliases(self):
        ...
        """
        # TODO: optionally create aliases for resources introduced in __init__
        ...
        pass  # TODO: remove this line if aliases is used
