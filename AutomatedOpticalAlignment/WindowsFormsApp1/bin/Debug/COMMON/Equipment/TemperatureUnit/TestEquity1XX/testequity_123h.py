...
For the top level API: See :py:class:`Equipment.TemperatureUnit.TestEquity1XX.testequity_123h`
::

    >>> from CLI.Equipment.TemperatureUnit.TestEquity1XX.testequity_123h import TestEquity123H
    >>> tu = TestEquity123H('GPIB1::23::INSTR')
    >>> tu.connect()
    >>> tu.unit_temperature
    25.0
    >>> tu.setpoint = 100
...
class TestEquity123H(TestEquity10X):
    """
    Driver for Test Equity 123H
    """
