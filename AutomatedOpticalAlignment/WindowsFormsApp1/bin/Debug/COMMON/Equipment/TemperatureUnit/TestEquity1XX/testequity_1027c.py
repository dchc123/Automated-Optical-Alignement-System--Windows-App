...
For the top level API: See :py:class:`Equipment.TemperatureUnit.TestEquity1XX.testequity_1027c`
::

    >>> from CLI.Equipment.TemperatureUnit.TestEquity1XX.testequity_1027c import TestEquity1027C
    >>> tu = TestEquity1027C('GPIB1::23::INSTR')
    >>> tu.connect()
    >>> tu.unit_temperature
    25.0
    >>> tu.setpoint = 100
...
class TestEquity1027C(TestEquity10X):
    """
    Driver for Test Equity 1027C
    """

    CAPABILITY = {'temperature': {'min': -73, 'max': 175}}
