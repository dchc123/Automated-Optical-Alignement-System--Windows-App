...
For the top level API: See :py:class:`Equipment.TemperatureUnit.TestEquity1XX.testequity_115a`
::

    >>> from CLI.Equipment.TemperatureUnit.TestEquity1XX.testequity_115a import TestEquity115A
    >>> tu = TestEquity115A('GPIB1::23::INSTR')
    >>> tu.connect()
    >>> tu.unit_temperature
    25.0
    >>> tu.setpoint = 100
...
class TestEquity115A(TestEquity10X):
    """
    Driver for Test Equity 115A
    """
