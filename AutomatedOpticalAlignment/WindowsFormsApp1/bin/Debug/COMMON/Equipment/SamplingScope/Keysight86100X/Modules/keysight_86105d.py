...
class Keysight86105D(Keysight86100XOpticalModule):
    """
...
class Keysight86105DSingleOpt(Keysight86100XSingleOpticalModule):
    """
    Keysight 86105D Single Channel
    """
...
class Keysight86105DSingleElec(Keysight86100XSingleElectricalModule):
    """
    Keysight 86105D Module
    """
    CAPABILITY = {'software_delay': {'min': -10e-9, 'max': 10e-9},
    ...
    def __init__(self, module_id, module_option, channel_number, handle,
        ...
        super().__init__(module_id=module_id, module_option=module_option,
                         channel_number=channel_number, handle=handle,
                         interface=interface,pam=pam, dummy_mode=dummy_mode, **kwargs)
