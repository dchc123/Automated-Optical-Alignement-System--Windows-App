"""
| $Revision:: 283363                                   $:  Revision of last commit
| $Author:: tobias_l@SEMNET.DOM                        $:  Author of last commit
| $Date:: 2018-11-03 01:15:56 +0000 (Sat, 03 Nov 2018) $:  Date of last commit
| --------------------------------------------------------------------------------
...
class KeysightN1055A(Keysight86100XElectricalModule):
    """
    Keysight N1055A Module
    """
...
class KeysightN1055ASingle(Keysight86100XSingleElectricalModule):
    """
    Keysight N1055A Single Channel
    """
    def __init__(self, module_id, module_option, channel_number, handle,
    ...
    def bandwidth(self):
        ...
        :type: str
        :raise ValueError: exception if bandwidth is not '35.0E+9', '50.0E+9'
        """
    ...
    def bandwidth(self, value):
        ...
        :raise ValueError: exception if bandwidth is not '35.0E+9', '50.0E+9'
        """
        input_list = ['35.0E+9', '50.0E+9']
        if value not in input_list:
            raise ValueError("Please specify either '35.0E+9', '50.0E+9'")
        else:
...
class KeysightN1055ADiff(Keysight86100XDiffElectricalModule):
    """
    Keysight N1055A Module
    """
    def __init__(self, module_id, module_option, channel_number, handle,
