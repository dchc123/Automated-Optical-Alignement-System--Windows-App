...
class KeysightN1046A(Keysight86100XElectricalModule):
    """
    Keysight N1046A Module
    """
...
class KeysightN1046ASingle(Keysight86100XSingleElectricalModule):
    """
    Keysight N1046A Single Channel
    """
    def __init__(self, module_id, module_option, channel_number, handle,
    ...
    def bandwidth(self):
        ...
        :value: - '20.0E+9'
                ...
                - '85.0E+9'
        :type: int
        :raise ValueError: exception if bandwidth is not '45.0E+9', '60.0E+9', '75.0E+9', '85.0E+9'
        """
    ...
    def bandwidth(self, value):
        ...
        :raise ValueError: exception if bandwidth is not '45.0E+9', '60.0E+9', '75.0E+9', '85.0E+9'
        """
        input_list = ['45.0E+9', '60.0E+9', '75.0E+9', '85.0E+9']
        if value not in input_list:
            raise ValueError("Please specify either '45.0E+9', '60.0E+9', '75.0E+9' or '85.0E+9'")
        else:
...
class KeysightN1046ADiff(Keysight86100XDiffElectricalModule):
    """
    Keysight N1046A Module
    """
    def __init__(self, module_id, module_option, channel_number, handle,
