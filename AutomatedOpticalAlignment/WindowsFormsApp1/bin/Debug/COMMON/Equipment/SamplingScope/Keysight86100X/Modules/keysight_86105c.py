...
class Keysight86105C(Keysight86100XOpticalModule):
    """
    Keysight 86105C Module
    """
...
class Keysight86105CSingleOpt(Keysight86100XSingleOpticalModule):
    """
    Keysight 86105C Single Opt Channel
    """
    def __init__(self, module_id, module_option, channel_number, handle,
...
class Keysight86105CSingleElec(Keysight86100XSingleElectricalModule):
    """
    Keysight 86105C Single Elec Channel
    """
    CAPABILITY = {'software_delay': {'min': -10e-9, 'max': 10e-9},
                  'skew': {'min': -1, 'max': 1},
                  'bandwidth': [12.4e9, 20e9]}

    def __init__(self, module_id, module_option, channel_number, handle,
                 pam, interface, dummy_mode=False, **kwargs):
        """
        Initialize instance
