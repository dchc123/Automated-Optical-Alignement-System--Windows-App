...
For the top level API: See :py:class:`.Keysight81591B`
::

    >>> from CLI.Equipment.OpticalSwitch.Keysight8159XX.keysight_81591b import Keysight81591B
    >>> sw = Keysight81591B('GPIB1::23::INSTR', 1)
    >>> sw.connect()

For channel level API:
:py:class:`.Keysight81591BChannel`
::
...
class Keysight81591B(Keysight8159XX):
    """
    Keysight 81591B optical switch driver
    """
    ...
    def __init__(self, address, slot_number, interface=None, dummy_mode=False, **kwargs):
        ...
        """:type: list of Keysight81591BChannel"""
        self.channel.append(Keysight81591BChannel(channel_number=1, slot_number=slot_number, interface=interface,
                                                  dummy_mode=dummy_mode))


class Keysight81591BChannel(Keysight8159XXChannel):
    """
    Keysight 81591B optical switch channel
    """

    CAPABILITY = {'in_ports': [1], 'out_ports': [1, 2]}
