...
class AgilentDSO7XXXA(BaseRealtimeScope):
    """
    Driver for Agilent DSO7000A series Real-time Scope
    """
    ...
    def __init__(self, address, interface=None, dummy_mode=False, **kwargs):
        ...
        """:type: list of AgilentDSO7XXXAChannel"""
        self.trigger = AgilentDSO7XXXATrigger(interface=interface, dummy_mode=dummy_mode)
        self._mode = None
...
class AgilentDSO7XXXAChannel(BaseRealtimeScopeChannel):
    """
    Agilent DSO7XXXA Channel driver
    """
    ...
    def __init__(self, channel_number, interface, dummy_mode, **kwargs):
        ...
        self.probe = AgilentDSO7XXXAProbe(channel_number=channel_number, interface=interface, dummy_mode=dummy_mode)
        self.measurement = AgilentDSO7XXXAMeasurement(channel_number=channel_number, interface=interface,
...
class AgilentDSO7XXXATrigger(BaseRealtimeScopeSubBlock):
    """
    AgilentDSO7XXXA trigger driver
    """
...
class AgilentDSO7XXXAProbe(BaseRealtimeScopeSubBlock):
    """
    AgilentDSO7XXXA Probe driver
    """
    ...
    def head_type(self):
        ...
        """
        raise NotSupportedError('AgilentDSO7XXXA does not support head type settings')
    ...
    def signal_type(self):
        ...
        """
        raise NotSupportedError('AgilentDSO7XXXA does not support signal type settings')
...
class AgilentDSO7XXXAMeasurement(BaseRealtimeScopeSubBlock):
    """
    AgilentDSO7XXXA Measurement block driver
    """
    def __init__(self, channel_number, interface, dummy_mode, **kwargs):
        """
        Initialize instance
