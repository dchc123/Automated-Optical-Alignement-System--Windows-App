...
class Keithley2400(Keithley24XX):
    ...
    def __init__(self, address, interface=None, dummy_mode=False, **kwargs):
        ...
        """:type: list of Keithley2400Channel"""

        self.channel.append(Keithley2400Channel(channel_number=1, interface=interface, dummy_mode=dummy_mode))


class Keithley2400Channel(Keithley24XXChannel):
    """
    ...
    def __init__(self, channel_number, interface, dummy_mode, **kwargs):
        ...
        self.source = Keithley2400SourceParentBlock(channel_number=channel_number, interface=interface,
                                                    dummy_mode=dummy_mode)
        self.measure = Keithley2400MeasureParentBlock(channel_number=channel_number, interface=interface,
                                                      dummy_mode=dummy_mode)


class Keithley2400SourceParentBlock(Keithley24XXSourceParentBlock):
    """
    ...
    def __init__(self, channel_number, interface, dummy_mode, **kwargs):
        ...
        self.voltage = Keithley2400SourceVoltageBlock(channel_number=channel_number, type_='voltage',
                                                      interface=interface, dummy_mode=dummy_mode)
        self.current = Keithley2400SourceCurrentBlock(channel_number=channel_number, type_='current',
                                                      interface=interface, dummy_mode=dummy_mode)


class Keithley2400MeasureParentBlock(Keithley24XXMeasureParentBlock):
    """
       Keithly2400 Source Mode Sub Block
       """
    ...
    def __init__(self, channel_number, interface, dummy_mode, **kwargs):
        ...
        self.voltage = Keithley2400MeasureBlock(channel_number=channel_number, type_='voltage',
                                                interface=interface, dummy_mode=dummy_mode)
        self.current = Keithley2400MeasureBlock(channel_number=channel_number, type_='current',
                                                interface=interface, dummy_mode=dummy_mode)
        self.resistance = Keithley2400MeasureBlock(channel_number=channel_number, type_='resistance',
                                                   interface=interface, dummy_mode=dummy_mode)


class Keithley2400SourceVoltageBlock(Keithley24XXSourceVoltageBlock):
    """
    Keithley2400 Sub Block
    """
...
class Keithley2400SourceCurrentBlock(Keithley24XXSourceCurrentBlock):
    """
    Keithley2400 Sub Block
    """
    CAPABILITY = {'voltage': {'source': {'min': 5e-6, 'warn': 21, 'max': 210}},
...
class Keithley2400MeasureBlock(Keithley24XXMeasureBlock):
    """
    Keithley2400 Resistance Sub Block
    """
